...
class CmsStorage
{
    ...
    public static function defaultStore(): array
    {
        ...
        return [
            ...
            'promotions' => [
                [
                    'id' => 1,
                    'title' => 'New Customer Referral Offer',
                    'description' => 'Use referral code at booking for discount on GPS tracker installation.',
                    'promo_code' => 'ESSREF2026',
    ...
    public static function defaultChatFaqs(): array
    {
        return [
            ...
            ['id' => 10, 'question' => 'Do you have promo or referral codes?', 'answer' => 'Yes! Check active offers on our website home and packages page. Current referral code may be shown in the promotions bar. Call us to confirm before booking.', 'keywords' => 'promo,discount,referral,code,offer,percent,off', 'status' => 'active', 'sort_order' => 10],

...
@section('title', 'About Us — ESS-TRACK BY ESSPL')
...
<section style="background: var(--nv); padding: 160px 0 100px; color: #fff; position: relative; overflow: hidden;">
    ...
    <div class="wrap" style="position: relative; z-index: 2; text-align: center;">
        <div class="lbl c" style="color: var(--or);">Our Story</div>
        <h2 class="ttl" style="color: #fff; margin-bottom: 20px;">Dedicated To <span style="color: var(--or);">Your Safety</span></h2>
        <p class="dsc" style="color: rgba(255,255,255,0.7); max-width: 700px; margin: 0 auto;">Since 2009, ESS-TRACK BY ESSPL has been Pakistan's leading provider of vehicle security and fleet management solutions.</p>
    </div>
</section>
    ...
    <div class="wrap">
        <div style="display: flex; gap: 60px; align-items: center; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 300px;" data-aos="fade-right">
                <div class="lbl">Who We Are</div>
                <h2 class="ttl">Excellence In Surveillance</h2>
                <p class="dsc" style="margin-bottom: 25px;">Electronic Safety & Security Pvt. Ltd. (ESSPL) was established with a clear vision: to provide the most reliable and technologically advanced security solutions to the people of Pakistan.</p>
                <p class="dsc" style="margin-bottom: 35px;">We specialize in GPS-based tracking systems, utilizing the latest 3G/2G communication platforms. Our systems are designed to provide unmatched precision, whether you are tracking a single car or managing a commercial fleet of hundreds.</p>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div style="padding: 25px; background: var(--of); border-radius: 20px;">
                        ...
                        <p style="font-size: 13px; color: var(--gy);">To empower vehicle owners with real-time data and security tools that protect their assets.</p>
                    </div>
                    <div style="padding: 25px; background: var(--of); border-radius: 20px;">
                        <h4 style="color: var(--nv); font-size: 17px; margin-bottom: 10px;">Our Vision</h4>
                        <p style="font-size: 13px; color: var(--gy);">To be the undisputed leader in GPS tracking by delivering innovation and trust.</p>
                    </div>
                </div>
            </div>
            <div style="flex: 0.8; min-width: 300px;" data-aos="fade-left">
                <img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1000&auto=format&fit=crop" alt="Team Work" style="width: 100%; border-radius: 30px; box-shadow: 0 30px 60px rgba(0,0,0,0.1);">
            </div>
        </div>
    </div>
</section>
...
<section style="background: var(--nv); color: #fff; padding: 120px 0;">
    <div class="wrap">
        <div class="tc" style="margin-bottom: 70px;">
            <div class="lbl c" style="color: var(--or);">The ESS Advantage</div>
            <h2 class="ttl" style="color: #fff;">Why Thousands Trust Us</h2>
        </div>
    ...
    <div class="wrap">
        <div style="display: flex; gap: 60px; align-items: center; flex-wrap: wrap-reverse;">
            <div style="flex: 0.8;" data-aos="fade-right">
                <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1000&auto=format&fit=crop" alt="Our Office" style="width: 100%; border-radius: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
            </div>
            <div style="flex: 1.2;" data-aos="fade-left">
                <div class="lbl">Expertise</div>
                <h2 class="ttl">Our Technical Prowess</h2>
                <p class="dsc" style="margin-bottom: 25px;">Behind the screens at ESS-TRACK BY ESSPL is a team of software engineers, hardware experts, and security specialists working tirelessly to maintain our 99.9% uptime.</p>
...
<section style="background: var(--of); padding: 100px 0; text-align: center;">
    <div class="wrap">
        <h2 class="ttl" style="margin-bottom: 30px;">Partner With Pakistan's Most Trusted Tracker</h2>
        <a href="{{ route('contact') }}" class="bo">Get Started Today</a>
    </div>
</section>
@endsection
